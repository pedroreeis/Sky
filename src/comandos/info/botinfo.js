...
module.exports = {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(`Tag: **${client.user.tag}**\nApelido: **${message.guild.me.nickname ? message.guild.me.nickname : 'Sem apelidos'}**\nId: **${client.user.id}**\n`)
      .addField('Informações Discord', `
        ...
        :pencil: **Prefixo local: ** ${db.guild.prefix}
        `, true)
        .addField('Tecnlogias Usadas', `
        <:download:765015707322548234> **Linguagem:** JavaScript
        <:discordjs:765015707058307084> **Livraria:** Discord.js
        <:host:765015707372224543> **Hospedagem:** Heroku
